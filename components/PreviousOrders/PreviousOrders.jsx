  ...
  return (
    <>
      <div className="max-md:hidden">
        <div className="mt-5 justify-between items-center sm:w-[90%] bg-[#f8f8f8]  p-[1.4rem] mb-[2rem] min-h-[7rem]">
      ...
      <div className="md:hidden">
        <div className="flex justify-between items-center sm:w-[90%] bg-[#f8f8f8]  p-[1.4rem] mb-[2rem] min-h-[7rem]">
          <h1 className="text-3xl pb-0">Prethodne kupovine</h1>
        </div>
        {previousOrders?.items?.map((order, index) => {
          return (
            <>
              <div className="border border-[#f0f0f0]  mb-[2rem]">
