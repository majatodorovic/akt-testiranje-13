    ...
    <>
      <div className="profilNav max-lg:hidden">
        <div className="flex flex-col gap-2 text-lg">
          <button
            className={`text-start py-[1.2rem] pl-[1rem]  transition-all ease lg:min-w-[195px] ${
              selectedButton === 0
                ? "bg-croonus-4 text-white"
                : " hover:bg-croonus-4 hover:text-white bg-croonus-gray"
            }`}
          ...
          <button
            className={`text-start py-[1.2rem] pl-[1rem]  transition-all ease lg:min-w-[195px] ${
              selectedButton === 1
                ? "bg-croonus-4 text-white"
                : "bg-croonus-gray hover:bg-croonus-4 hover:text-white"
            }`}
