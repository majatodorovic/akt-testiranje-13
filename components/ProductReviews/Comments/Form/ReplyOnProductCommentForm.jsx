...
import { useAddReplayOnReviewComment } from "@/hooks/productReviews.hooks";
import formFields from "./jsonData/replyOnProductFormFields";

/**
 * Component for submitting a reply to a product review comment.
 *
 ...
 */
const ReplyOnProductCommentForm = ({ id, setActiveReply, activeReply }) => {
  ...
  const { mutate: addReplayOnReviewComment, isPending } =
    useAddReplayOnReviewComment();
...
export default ReplyOnProductCommentForm;
