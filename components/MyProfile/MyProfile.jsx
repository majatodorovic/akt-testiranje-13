          ...
          <div className="grid grid-cols-2 gap-x-10 pb-4 max-xl:text-base mt-[2rem] mb-[1rem]">
            <div className="flex flex-col gap-3 max-xl:col-span-3 xl:col-start-1 xl:col-end-2">
              <div className="flex flex-col gap-2">
                ...
                <input
                  className={`max-sm:text-sm py-[0.8rem] border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0 text-black `}
                  type="text"
                  onInput={(e) => {
                    setData((prev) => ({
                      ...prev,
              ...
              <div className="flex flex-col gap-2 max-xl:mt-2">
                ...
                <input
                  ...
                  disabled={disabled}
                  id="phone"
                  className={`max-sm:text-sm py-[0.8rem] border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0 `}
          ...
          <div className="flex gap-3 max-xl:col-span-3 xl:col-start-1 xl:col-end-2 my-4 ">
            ...
            <div className="sm:grid sm:grid-cols-2 sm:gap-x-3 max-sm:w-full max-sm:max-w-[100%] w-full">
              <div className="sm:flex sm:flex-col sm:gap-2 max-xl:mt-2">
                ...
                <input
                  className={`max-sm:text-sm py-[0.8rem] border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0 max-sm:w-full `}
                  type="text"
                  id="pib"
                  name="pib"
                  onInput={(e) => {
