      ...
      <div className="h-[100%] flex flex-col items-center">
        <div className="loginHolder lg:w-[74%] max-lg:w-[90%] max-sm:w-[94%]">
          ...
          <button
            ...
            className="bg-croonus-4  text-white py-[0.7rem] px-[1.3rem] text-sm mt-[2rem] hover:bg-opacity-70"
          >
            NAPRAVI NALOG
          </button>
          ...
          >
            ...
            >
                ...
                <form className="mt-4 grid sm:grid-cols-2 gap-x-10 pb-4 max-xl:text-base ">
                  ...
                  <div className=" flex sm:gap-3 sm:py-3 relative flex-col max-sm:mt-[2rem]">
                    <div className="termsAgree flex items-center">
                      ...
                      >
                        Slažem se sa AKT politikom privatnosti i čuvanjem
                        podataka.
                      </label>
                    </div>
              ...
              <button
                ...
                className="bg-croonus-4  text-white py-[0.7rem] px-[1.3rem] text-sm hover:bg-opacity-70 w-fit ml-auto"
              >
                {loading ? (
