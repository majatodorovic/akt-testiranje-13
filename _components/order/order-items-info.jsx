    ...
    >
      ...
      >
        ...
        {order?.items?.map((item, index) => {
          return (
            <Link href={`/${item?.basic_data?.slug}`} key={index}>
              <div
              ...
              >
                ...
                <div className={`flex flex-col gap-y-1`}>
                  ...
                  <p className="text-xs">
                    {parseFloat(item?.basic_data?.quantity) % 1 === 0
                      ? `${parseInt(item?.basic_data?.quantity)} kom`
                      : `${item?.basic_data?.quantity} kom`}
                  </p>
                  <p
                    className={`pr-2 w-fit text-xs mt-2 font-bold text-center`}
                  >
